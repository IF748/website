...
```
  ...
  -d, --dir string                                                       output directory to write documentation (default "doc")
      ...
      --healthcheck-max-retry-backoff duration                           Maximum wait time between health check reconnection attempts. Caps the exponential backoff to prevent long delays after tablet recovery. (default 10s)
